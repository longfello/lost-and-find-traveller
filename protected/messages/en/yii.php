...
return array (
  ...
  'Can not generate multiple insert command with empty data set.' => '',
  ...
  'Encryption key length can be {keyLengths}' => '',
  'Encryption key length must be between {minLength} and {maxLength}.' => '',
  'Encryption key should be a string.' => '',
  ...
  'Failed to validate key. Supported key lengths of cipher not known.' => '',
  ...
  'Unable to upload the file "{file}" because of an unrecognized error.' => '',

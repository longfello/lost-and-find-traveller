<?php
	define("HTTPS_LOGIN", "gostantus"); //Ваш логин для HTTPS-протокола
	define("HTTPS_PASSWORD", "qawsedsms"); //Ваш пароль для HTTPS-протокола
	define("HTTPS_ADDRESS", "http://lcab.sms-sending.ru/"); //HTTPS-Адрес, к которому будут обращаться скрипты. Со слэшем на конце.
	define("HTTP_ADDRESS", "http://lcab.sms-sending.ru/"); //HTTP-Адрес, к которому будут обращаться скрипты. Со слэшем на конце.

    ...
    <table style="width:auto;margin:0;">
        <tr>
            ...
            <td>                                                    
                ...
                <?php echo $form->dropDownList($model,'category', CHtml::listData($ArticleCategory, 'id_cat', 'name'),array('empty'=>'') ); ?> 
     ...
     <div class="row">
        ...
        } else echo $form->textArea($model,'annotation',array('rows'=>6,'cols'=>50));
         ?>
    </div>
    <div class="row">

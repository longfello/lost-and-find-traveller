...
class Cms extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('lft, rgt, level, parent_id, type, overview_page,category, access_level', 'numerical', 'integerOnly' => true),
            array('url, name, title, layout, section, subsection', 'length', 'max' => 255),
            array('content, layout, section, subsection,annotation,  overview_page, keywords, description, access_level', 'safe'),
            ...
            array('id, lft, rgt, level, parent_id, type,annotation, url, name, category,title, content, keywords, description, access_level', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
			'idCat' => array(self::BELONGS_TO, 'ArticleCategory', 'category'),	
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'access_level' => 'Page access',
            'annotation' => 'Вводный текст',			
        );
    }

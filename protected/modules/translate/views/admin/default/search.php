...
<div id="moduletitle">
  ...
  <a href="<?php echo Yii::app()->createUrl('admin2/translate/default/index') ?>"><?=Yii::t('TranslateModule', 'выбрать другой язык')?></a>
</div>

<form action="<?php echo Yii::app()->createUrl('admin2/translate/default/search/languageid/'.$languageid)?>" method="POST">
  ...
  <div id="existingfiles">
    ...
    <table>
      ...
      foreach ($existingfiles as $key => $value) {
        ...
        $link = CHtml::Link(
          Yii::t('TranslateModule', 'Перевод'), Yii::app()->createUrl('admin2/translate/default/translate', array('filename' => $value, 'languageid' => $languageid,)));

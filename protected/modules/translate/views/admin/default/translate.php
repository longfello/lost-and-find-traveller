...
<div id="moduletitle">
    ...
    <a href=<?php echo Yii::app()->createUrl('admin2/translate/default/edit', array('languageid' => $languageid)) ?>><?=Yii::t('TranslateModule', 'выбрать другой файл')?></a>
    ...
    <table id="translationtable">
        ...
        <tbody>
            ...
            $form = $this->beginWidget('CActiveForm', array(
                'action' => Yii::app()->createUrl('admin2/translate/default/savefile'),
                'method' => 'post',
                'id' => 'translate',
            ));
...
<table id="translationinsert">
    ...
    <tbody>
        <?php
        $form = $this->beginWidget('CActiveForm', array(
            'action' => Yii::app()->createUrl('admin2/translate/default/insertline'),
            'method' => 'post',
            'id' => 'insertline',
        ));
        ?>
